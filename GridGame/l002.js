//gridgame.js
    ...
    walls = [
      ...
      {x: 17, y: 3, color: 'gray'},
      {x: 16, y: 3, color: 'gray'},
      {x: 9, y: 10, color: 'yellow'},
      {x: 8, y: 10, color: 'gray'},
      {x: 8, y: 11, color: 'gray'},
      {x: 9, y: 11, color: 'gray'},
      {x: 10, y: 11, color: 'gray'},
      {x: 10, y: 10, color: 'gray'},
      {x: 11, y: 10, color: 'gray'},
      {x: 12, y: 10, color: 'gray'},
      {x: 12, y: 9, color: 'gray'},
      {x: 12, y: 8, color: 'gray'},
      {x: 13, y: 10, color: 'gray'},
      {x: 14, y: 10, color: 'gray'},
      {x: 15, y: 10, color: 'gray'},
      {x: 15, y: 9, color: 'gray'},
      {x: 15, y: 8, color: 'gray'},
      {x: 16, y: 10, color: 'gray'},
      {x: 17, y: 10, color: 'gray'},
      ...
      {x: 15, y: 12, color: 'gray'},
      {x: 18, y: 11, color: 'gray'},
      {x: 18, y: 12, color: 'gray'},
      {x: 9, y: 12, color: 'gray'},
      {x: 19, y: 10, color: 'blue'},
      {x: 19, y: 9, color: 'gray'},
      {x: 20, y: 9, color: 'gray'},
      {x: 20, y: 10, color: 'gray'},
      {x: 20, y: 11, color: 'gray'},
    ...
    elements = [
      {x: 2, y: 2, color: 'red'},
      {x: 10, y: 9, color: 'yellow'},
      {x: 13, y: 9, color: 'green'},
      {x: 16, y: 9, color: 'blue'},
    ];
    goals = [
      {x: 7, y: 7, color: 'red'},
      {x: 20, y: 2, color: 'yellow'},
      {x: 11, y: 11, color: 'green'},
      {x: 14, y: 11, color: 'blue'},
    ];
    
    redirectionBoxes = [

      new RedirectionBox(6, 16, 'rgba(255, 155, 75, 84)', 15),
      new RedirectionBox(8, 18, 'rgba(255, 155, 75, 84)', 30),
      new RedirectionBox(10, 20, 'rgba(255, 155, 75, 84)', 45),
      new RedirectionBox(19, 22, 'rgba(255, 155, 75, 84)', 60),
      new RedirectionBox(14, 24, 'rgba(255, 155, 75, 84)', 75),
      new RedirectionBox(15, 26, 'rgba(255, 155, 75, 84)', 90),
    
      new RedirectionBox(6, 26, 'rgba(255, 155, 75, 84)', 105),
      new RedirectionBox(5, 28, 'rgba(255, 155, 75, 84)', 120),
      new RedirectionBox(18, 30, 'rgba(255, 155, 75, 84)', 135),
      new RedirectionBox(13, 22, 'rgba(255, 155, 75, 84)', 150),
      new RedirectionBox(16, 23, 'rgba(255, 155, 75, 84)', 165),
      new RedirectionBox(19, 24, 'rgba(255, 155, 75, 84)', 180),
    ...
    keys = [
        new Key(9, 2, 'purple', 0),
        new Key(16, 2, 'purple', 1),

      ];
      
      bombs.push(new Bomb(17, 12));
      bombs.push(new Bomb(7, 2));
